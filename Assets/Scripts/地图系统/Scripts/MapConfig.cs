...
namespace Map
{
    ...
    public class MapConfig : ScriptableObject
    {
        ...
        [OneLineWithHeader]
        [NonSerialized] public IntMinMax numOfPreBossNodes;
        [OneLineWithHeader]
        [NonSerialized] public IntMinMax numOfStartingNodes;

        [Tooltip("Increase this number to generate more paths")]
        [NonSerialized] public int extraPaths;
        ...
        public NodeType[] GetRandomNode(int num)
        {
            ...
            for (int i = 0; i < num; i++)
            {
                ...
                // 生成随机权重值（修复整数精度问题：使用 [0, totalWeight] 闭区间）
